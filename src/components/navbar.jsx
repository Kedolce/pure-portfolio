function Navbar() {
  return (
    <nav className="fixed left-0 right-0 z-50 flex items-center justify-between max-w-4xl px-8 py-3 mx-auto text-white border rounded-full top-8 border-white/5 bg-black/20 backdrop-blur-md">
